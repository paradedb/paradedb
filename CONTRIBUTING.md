...
- **Running:** Run a suite interactively with `cargo run -- ui suites/single-node-planner-paths.toml`, or headlessly with `cargo run -- headless suites/single-node-planner-paths.toml --runtime=300000`.
