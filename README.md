...
- [x] [Native Vector Search](https://docs.paradedb.com/documentation/vector/overview) (beta)
- [x] [Native Hybrid Search](https://docs.paradedb.com/documentation/hybrid/overview) (beta)
