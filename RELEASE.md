...
To test a source revision without creating a GitHub Release, run **Test pg_search (Cloud)**
(`test-pg_search-cloud.yml`) from `main` in the repository whose source you want to build.
