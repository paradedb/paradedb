...
SET enable_seqscan=off; SET enable_bitmapscan=off; SET enable_sort=off; SET hnsw.iterative_scan=relaxed_order; SET hnsw.ef_search={{ ef_search_10pct }}; SELECT _id, title FROM cohere_wiki
