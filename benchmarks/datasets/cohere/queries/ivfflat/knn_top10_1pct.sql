...
SET enable_seqscan=off; SET enable_bitmapscan=off; SET enable_sort=off; SET ivfflat.iterative_scan=relaxed_order; SET ivfflat.probes={{ probes_1pct }}; SELECT _id, title FROM cohere_wiki
