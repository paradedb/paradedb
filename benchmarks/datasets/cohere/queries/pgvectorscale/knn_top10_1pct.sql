...
SET enable_seqscan=off; SET enable_bitmapscan=off; SET enable_sort=off; SET diskann.query_search_list_size={{ pgvectorscale_search_list_size_1pct }}; SET diskann.query_rescore={{ pgvectorscale_query_rescore }}; SELECT _id, title FROM cohere_wiki
