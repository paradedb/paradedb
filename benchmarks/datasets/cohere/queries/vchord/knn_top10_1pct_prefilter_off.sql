...
SET enable_seqscan=off; SET enable_bitmapscan=off; SET enable_sort=off; SET vchordrq.prefilter=off; SET vchordrq.probes={{ vchord_probes_1pct_off }}; SET vchordrq.epsilon=1.9; SELECT _id, title FROM cohere_wiki
