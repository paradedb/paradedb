...
SET paradedb.enable_columnar_sort TO off; SET paradedb.enable_join_custom_scan TO off; EXPLAIN ANALYZE SELECT
    f.id,
    f.title,
    f."createdAt"
FROM files f
...
SET paradedb.enable_columnar_sort TO on; SET paradedb.enable_join_custom_scan TO off; EXPLAIN ANALYZE SELECT
    f.id,
    f.title,
    f."createdAt"
FROM files f
