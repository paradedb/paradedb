...
-- normal scan
SET paradedb.enable_aggregate_custom_scan TO off; SET paradedb.enable_mixed_fast_field_exec = false; SELECT severity, COUNT(*) FROM benchmark_logs WHERE id @@@ paradedb.all() GROUP BY severity;
