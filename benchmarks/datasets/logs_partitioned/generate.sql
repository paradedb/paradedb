...
DROP TABLE IF EXISTS benchmark_logs_partitioned CASCADE;
CREATE TABLE benchmark_logs_partitioned (
    id SERIAL,
    message TEXT,
    country VARCHAR(255),
    severity INTEGER,
...
-- 8 quarterly partitions covering 2020-01-01 to 2021-12-31
CREATE TABLE benchmark_logs_partitioned_2020q1 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2020-01-01') TO ('2020-04-01');
CREATE TABLE benchmark_logs_partitioned_2020q2 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2020-04-01') TO ('2020-07-01');
CREATE TABLE benchmark_logs_partitioned_2020q3 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2020-07-01') TO ('2020-10-01');
CREATE TABLE benchmark_logs_partitioned_2020q4 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2020-10-01') TO ('2021-01-01');
CREATE TABLE benchmark_logs_partitioned_2021q1 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2021-01-01') TO ('2021-04-01');
CREATE TABLE benchmark_logs_partitioned_2021q2 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2021-04-01') TO ('2021-07-01');
CREATE TABLE benchmark_logs_partitioned_2021q3 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2021-07-01') TO ('2021-10-01');
CREATE TABLE benchmark_logs_partitioned_2021q4 PARTITION OF benchmark_logs_partitioned FOR VALUES FROM ('2021-10-01') TO ('2022-01-01');


-- Insert data

INSERT INTO benchmark_logs_partitioned (message, country, severity, timestamp, metadata)
SELECT
  (ARRAY[
