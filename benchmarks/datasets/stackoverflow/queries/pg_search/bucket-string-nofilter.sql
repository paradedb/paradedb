...
SELECT owner_display_name, pdb.agg('{"terms": {"field": "owner_display_name", "size": 65000}}'::jsonb) FROM stackoverflow_posts WHERE id @@@ paradedb.all() GROUP BY owner_display_name;
