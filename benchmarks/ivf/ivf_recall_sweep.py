...
# fingerprint (unit regime, cohere-100k repl-2 rebuild, none/f=0.05/K10,
# 200q): sha256 e9a87b2f… — the go-forward baseline; the count-regime
# baseline 9ce20f7a… is historical.
...
def main():
    ...
    if per_query_rows is not None:
        pq_cols = ["rung", "filter", "probe_fraction", "k",
                   ...
                   "exhausted", "probed_per_segment", "work_per_segment",
