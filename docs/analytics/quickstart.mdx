...
column-oriented layout via Apache Arrow and Parquet and leverage Apache Datafusion, a query engine 
...
That's it! `deltalake` tables behave like normal Postgres tables and accept regular Postgres queries, 
