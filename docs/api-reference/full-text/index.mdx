...
If you're not sure which tokenizer to use, you can refer to `paradedb.tokenizer` for a list of all available tokenizers. To evaluate and compare different tokenization strategies, use `paradedb.tokenize`.
