...
This approach is ideal for quickly bootstraping your ParadeDB cluster with some data. To keep ParadeDB in sync with an existing Postgres database in real time, [logical replication](/ingest/postgres/replication) should be configured.
