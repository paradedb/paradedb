...
The algorithm used by ParadeDB’s full text search is called BM25. It ranks documents by considering how often a term appears and how unique that term is across all documents.
