...
`@@@` does not perform any sorting on the result set. In particular, it does not compute or sort by BM25 score. [`score_bm25`](/api-reference/full-text/scoring) should be used for that.
