...
for [efficient filtering](/api/full-text/bm25#efficient-filtering).
...
Please refer to our [advanced search queries](/api/full-text/complex) guide for all available
query types.
