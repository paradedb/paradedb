...
table, which was created in the [quickstart](/api/quickstart#full-text-search).
...
[aggregations/faceting](/api/aggregations). They can also improve the query times of [filters](/api/full-text/bm25#efficient-filtering)
and BM25 scoring.
