...
More detailed benchmark results can be found in the extension [README](https://github.com/paradedb/paradedb/tree/dev/pg_bm25#benchmarks).
...
or [running the Postgres Docker image](https://github.com/paradedb/paradedb#self-hosted).
