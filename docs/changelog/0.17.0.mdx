---
title: 0.17.0
description: Changelog for ParadeDB v0.17.0
canonical: https://docs.paradedb.com/changelog/0.17.0
---
...
With this release, merging large layers happens in the background. This is configurable with the `background_layer_sizes` [index option](/documentation/configuration/write-throughput#background-layer-sizes)
