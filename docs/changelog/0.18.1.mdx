...
- Introduced the ability to add [slop](/v2/full-text/phrase#slop) to phrase queries in v2 of the API
...
The full changelog is available [here](https://github.com/paradedb/paradedb/releases/tag/v0.18.1).
