...
- Introduced two new settings, `paradedb.topk_retry_scale_factor` and `paradedb.max_topk_chunk_size`, which can be used to reduce the number of re-queries during a TopK
