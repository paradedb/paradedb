...
It has now been promoted to the default API and can be found documented at [http://www.paradedb.com/docs/documentation](/documentation/). The old API can be found [here](https://github.com/paradedb/paradedb/tree/main/docs/legacy/indexing/create-index.mdx) and will be removed in a future version.
