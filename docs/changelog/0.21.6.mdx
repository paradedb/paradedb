...
- Fixed an issue where [filter pushdown](/documentation/filtering/indexed) did not happen if non-text columns appeared after text columns in the index definition
