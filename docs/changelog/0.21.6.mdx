...
- Fixed an issue where [filter pushdown](/documentation/filtering/paradedb-fields) did not happen if non-text fields appeared after text fields in the index definition
