---
title: "Roadmap"
description: Last Updated July 13, 2023
---
...
**July 13, 2023: First MVP of Real-Time Server**
First MVP of the real-time server between Postgres and ElasticSearch working in a local Docker environment.

**July 11, 2023: More Embedding Models**
Introducing a wrapper for the Cohere embedding model and support for custom embedding functions.

**July 10, 2023: Pinecone Connector**

Support for Pinecone sinks added.
