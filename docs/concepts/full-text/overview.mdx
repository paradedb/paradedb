...
As of `0.25.0`, ParadeDB natively supports vector search inside its indexes. See [How Vector Search Works](/concepts/vector/overview) to learn more.

The two are complementary, and can be combined into a single ranking. See [How Hybrid Search Works](/concepts/hybrid/overview).
