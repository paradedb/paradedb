...
The instructions below assume you are on a Debian-based image. If you picked a different AMI, you will need to use the appropriate package manger (i.e. yum, etc.).
