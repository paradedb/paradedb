...
We recommend installing prebuilt binaries whenever available to keep the image size small. As an example,
let's install [PostGIS](https://github.com/postgis/postgis), an extension for geospatial data.
...
[PGXN](https://pgxn.org/) provides a comprehensive list of Postgres extensions.
