...
To configure high availability, we will be deploying the [ParadeDB Helm Chart](https://github.com/paradedb/charts).
This chart is also available on [Artifact Hub](https://artifacthub.io/packages/helm/paradedb/paradedb).
