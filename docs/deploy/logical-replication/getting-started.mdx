...
If you run ParadeDB on both the primary and standby nodes and want BM25 indexes
to replicate automatically through WAL, use [physical
replication](/deploy/self-hosted/physical-replication) instead.
