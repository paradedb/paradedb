...
There are three ways to deploy ParadeDB: [self-hosting ParadeDB](/deploy/self-hosted/kubernetes), using a ParadeDB container in a [cloud platform](/deploy/cloud-platforms/render), or using [ParadeDB BYOC](/deploy/byoc) (Bring Your Own Cloud).
...
For hobby, development, or staging environments, ParadeDB Community can be deployed to cloud platforms with minimal setup:
...
<Note>
  ...
  hobby, development, and staging environments. For production, we recommend [ParadeDB Enterprise](/deploy/enterprise)
