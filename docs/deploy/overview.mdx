...
This is because ParadeDB Community does not have write-ahead log (WAL) support. Without WALs, the index is not guaranteed to be durable. This means that data can be lost or the
