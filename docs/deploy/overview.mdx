...
There are three ways to deploy ParadeDB: [self-hosting ParadeDB](/deploy/self-hosted/kubernetes), using a ParadeDB container in a [cloud platform](#cloud-platforms), or using [ParadeDB BYOC](/deploy/byoc) (Bring Your Own Cloud).
