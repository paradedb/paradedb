...
This guide explains how to install `pg_analytics` inside an existing PostgreSQL database. These
...
Please follow these [instructions](https://github.com/paradedb/paradedb/tree/v0.1.4/pg_analytics#installation).
