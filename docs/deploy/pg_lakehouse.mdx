...
```bash
curl -L "https://github.com/paradedb/paradedb/releases/download/v0.7.4/pg_lakehouse-v0.7.4-pg16-arm64-ubuntu2204.deb" -o /tmp/pg_lakehouse.deb
sudo apt-get install -y /tmp/*.deb
```

Note: You can replace `v0.7.4` with the `pg_lakehouse` version you wish to install, and `pg16` with the version of Postgres you are using.

## Building from Source

Please follow these [instructions](https://github.com/paradedb/paradedb/tree/v0.7.4/pg_lakehouse#installation).
