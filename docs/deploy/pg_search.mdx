...
ParadeDB provides prebuilt binaries for the `pg_search` extension for Postgres 15 and 16 on Ubuntu 22.04. They can be found in [GitHub Releases](https://github.com/paradedb/paradedb/releases/latest). If you
