...
curl -L "https://github.com/paradedb/paradedb/releases/download/v0.8.2/pg_search-v0.8.2-ubuntu-22.04-amd64-pg16.deb" -o /tmp/pg_search.deb
sudo apt-get install -y /tmp/*.deb
```

Note: You can replace `v0.8.2` with the `pg_search` version you wish to install, and `pg16` with the version of Postgres you are using.

## Building from Source

Please follow these [instructions](https://github.com/paradedb/paradedb/tree/v0.8.2/pg_search#installation).
