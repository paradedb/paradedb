...
**Note**: The default `latest` tag is now Postgres 16. ParadeDB supports Postgres 13 to 17 and for a full list of available tags, please refer to the [Docker Hub page](https://hub.docker.com/r/paradedb/paradedb).
