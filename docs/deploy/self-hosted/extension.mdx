...
```bash Debian 13
# Available arch versions are amd64, arm64
curl -L "https://github.com/paradedb/paradedb/releases/download/v0.20.0/postgresql-17-pg-search_0.20.0-1PARADEDB-trixie_amd64.deb" -o /tmp/pg_search.deb
sudo apt-get install -y /tmp/*.deb
```
...
curl -L "https://github.com/paradedb/paradedb/releases/download/v0.20.0/pg_search_17-0.20.0-1PARADEDB.el10.x86_64.rpm" -o /tmp/pg_search.rpm
