...
<Note>
You can replace `0.10.2` with the `pg_search` version you wish to install and `16` with the version of Postgres you are using.
</Note>
...
<Note>
You can replace `0.1.4` with the `pg_analytics` version you wish to install and `16` with the version of Postgres you are using.
</Note>
...
That's it! To get started, follow the [quickstart guide](/api-reference/getting-started/quickstart).
