...
The fastest way to install ParadeDB is by pulling the ParadeDB Docker image and running it locally. This is the recommend deployment method for testing and development.
...
In this guide, we'll walk through setting up logical replication, also known as streaming replication, for ParadeDB. This setup allows you to replicate data from a primary server to one or more standby servers.
...
- Running pg_basebackup, which will create a snapshot of your primary onto your standy servers. This makes the initial replication much faster.
