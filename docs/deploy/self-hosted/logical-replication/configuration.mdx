...
Safely](/deploy/self-hosted/logical-replication/operational-guide#roll-out-ddl-safely).
...
Failures](/deploy/self-hosted/logical-replication/operational-guide#troubleshoot-apply-failures).
...
Tables](/deploy/self-hosted/logical-replication/operational-guide#add-new-tables).
