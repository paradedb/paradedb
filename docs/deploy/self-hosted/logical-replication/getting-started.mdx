...
canonical: https://docs.paradedb.com/deploy/self-hosted/logical-replication/getting-started
---
...
<Warning>
  ...
  Operational Guide](/deploy/self-hosted/logical-replication/operational-guide).
</Warning>
...
Guide](/deploy/self-hosted/logical-replication/operational-guide) for BM25
