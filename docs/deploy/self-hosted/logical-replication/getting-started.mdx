---
title: Configuring Logical Replication
description: How to set up ParadeDB as a logical replica of an existing Postgres like Amazon RDS.
...
<Note>
  Logical replication can be configured to replicate specific tables, column
  lists, or rows. Please see the [Postgres
  documentation](https://www.postgresql.org/docs/current/logical-replication.html).
</Note>
