...
<Note>
  [Foreign data
  wrapper](https://www.postgresql.org/docs/current/ddl-foreign-data.html) third
  party extensions can be used to query AWS S3 and other external data stores
  directly from ParadeDB.
</Note>
