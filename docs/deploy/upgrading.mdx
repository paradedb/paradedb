...
1. [`pg_search`](https://github.com/paradedb/paradedb/releases) is on version `0.12.0`
...
The latest version of the Docker image should be `0.12.0`.
...
```sql
ALTER EXTENSION pg_search UPDATE TO '0.12.0';
