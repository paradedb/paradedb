...
1. [`pg_search`](https://github.com/paradedb/paradedb/releases) is on version `0.15.3`
2. [`pg_analytics`](https://github.com/paradedb/pg_analytics/blob/main/pg_analytics.control) is on version `0.3.4`
...
The latest version of the Docker image should be `0.15.3`.
