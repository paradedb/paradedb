...
To upgrade the ParadeDB Docker image:
...
The latest version of the Docker image should be `0.11.1`.
...
2. Download and install the extension you wish to upgrade in the same way that it was initially insalled (e.g. via cURL)
3. Start Postgres
