...
The following query builder functions support JSON fields: [term](/documentation/advanced/term/term), [term set](/documentation/advanced/term/term-set), [fuzzy term](/documentation/advanced/term/fuzzy-term), [phrase](/documentation/advanced/phrase/phrase), [match](/documentation/advanced/full-text/match), [phrase prefix](/documentation/advanced/phrase/phrase-prefix), and [range](/documentation/advanced/term/range).
