...
<Note>
  Phrase doesn't work with Ngram tokenizer, consider using
  [parse](/documentation/advanced/compound/parse) or
  [match](docs/documentation/advanced/full-text/match)
</Note>
