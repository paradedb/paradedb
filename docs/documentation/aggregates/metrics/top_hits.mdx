...
canonical: https://docs.paradedb.com/documentation/aggregates/metrics/top_hits
---
...
If a text or JSON field is passed to `docvalue_fields`, it must be indexed with the [literal](/documentation/tokenizers/available-tokenizers/exact)
tokenizer.
