...
The following query allows Postgres to cache the underlying index files. This is a one-time cold query that will
**not** be fast, but allows subsequent queries to be fast.
