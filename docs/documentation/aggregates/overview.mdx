...
<Note>
Aggregate pushdown is currently a beta feature. To enable, set `paradedb.enable_aggregate_custom_scan`.
</Note>
...
[count](/documentation/aggregates/count), [sum](/documentation/aggregates/sum), [min/max](/documentation/aggregates/minmax),
[average](/documentation/aggregates/average), and [terms](/documentation/aggregates/terms).
