...
<Note>
As of `0.21.5`, fields using the [literal normalized](/documentation/tokenizers/available-tokenizers/literal-normalized) tokenizer can also be passed to
`pdb.agg`. Indexes created prior to `0.21.5` must be reindexed to use this feature.
</Note>
