...
In addition to full text search, Tantivy also has the ability to compute aggregates over a single BM25 index. Tantivy aggregate queries are written as JSON query strings.
