...
we recommend increasing `maintenance_work_mem`.
...
Generally speaking, this is the only setting that must be tuned to optimize index build times. The rest have sensible defaults.
