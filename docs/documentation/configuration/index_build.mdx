...
These actions affect the performance and memory consumption of `CREATE INDEX` and `REINDEX` statements.
...
[parallel indexing worker](/documentation/configuration/index#parallel-indexing-workers).
