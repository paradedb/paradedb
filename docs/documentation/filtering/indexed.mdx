...
canonical: https://www.paradedb.com/docs/documentation/filtering/indexed
---
...
For filters backed by another database index, see [External Indexes](/documentation/filtering/external-indexes).
