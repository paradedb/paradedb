---
title: ParadeDB Fields
description: Push filters into the ParadeDB index scan
canonical: https://www.paradedb.com/docs/documentation/filtering/paradedb-fields
---

ParadeDB fields are columns or expressions included in the ParadeDB index.
For filters over built-in scalar types and literal text fields, this is the most efficient path because the filter can be pushed directly into the ParadeDB scan.
For filters backed by another Postgres index, see [Non-ParadeDB Fields](/documentation/filtering/non-paradedb-fields).
...
| Operator | Meaning                                                                                           |
| -------- | ------------------------------------------------------------------------------------------------- |
| `@@@`    | [General search condition](/documentation/full-text/overview)                                     |
