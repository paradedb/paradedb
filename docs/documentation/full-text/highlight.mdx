...
```cs EF Core
var snippetOptions = new SnippetOptions("<i>", "</i>", null);
...
```cs EF Core
var snippetsOptions = new SnippetsOptions(null, null, 15, null, null, null);
...
```cs EF Core
var snippetsOptions = new SnippetsOptions(null, null, 15, 1, null, null);
...
```cs EF Core
var snippetsOptions = new SnippetsOptions(null, null, 15, 1, 1, null);
...
```cs EF Core
var snippetsOptions = new SnippetsOptions(null, null, 15, null, null, "position");
