...
<Note>
  ...
  with `snippet`, which follows new query syntax and has a different return
  type.
</Note>
...
<Accordion title="Expected Output">
  ```csv id | description | snippet | score_bm25
  ----+--------------------------+---------------------------------+------------
  2 | Plastic Keyboard | Plastic <b>Keyboard</b> | 3.2668595 1 | Ergonomic metal
  keyboard | Ergonomic metal <b>keyboard</b> | 2.8213787 (2 rows) ```
</Accordion>
