...
| ------------------- | ------------------------- | ----- | ------------------------------------------ | --------------------------------------------------- |
| Sleek running shoes | `sleek` `running` `shoes` | ✅    | Contains `running` or `shoes` (here both). |                                                     |
| Running shoes sleek | `sleek` `running` `shoes` | ✅    | Contains `running` or `shoes` (here both). | [Phrase](/documentation/full-text/phrase)           |
| SLeeK RUNNING ShOeS | `sleek` `running` `shoes` | ✅    | Contains `running` or `shoes` (here both). | [Lowercasing](/documentation/indexing/create-index) |
...
| White jogging shoes | `white` `jogging` `shoes` | ✅    | Contains `shoes`.                          | [Match conjunction](#match-conjunction)             |
