...
<Note>
  **Prerequisite** Before performing full text search over a table, ensure that
  it has been [indexed](/documentation/indexing/create-index) and properly
...
The left-hand side of `@@@` is the **[key field](/documentation/indexing/create-index#choosing-a-key-field)** and the right-hand side is
