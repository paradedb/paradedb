...
large tables, increasing the default [parallel worker count](/documentation/configuration/parallel) and [shared buffer size](/documentation/configuration/parallel#shared-buffers) is encouraged.
