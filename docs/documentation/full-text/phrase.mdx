...
stmt = (
    select(MockItem.description, MockItem.rating, MockItem.category)
    .where(MockItem.description.op("###")(literal_column("'running shoes'::pdb.whitespace")))
)
...
stmt = (
    select(MockItem.description, MockItem.rating, MockItem.category)
    .where(MockItem.description.op("###")(array(["running", "shoes"], type_=Text())))
)
...
stmt = (
    select(MockItem.description, MockItem.rating, MockItem.category)
    .where(MockItem.description.op("###")(literal_column("ARRAY['shoes', 'running']::pdb.slop(2)")))
)
