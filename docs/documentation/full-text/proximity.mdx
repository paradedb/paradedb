...
stmt = (
    ...
    .where(search.proximity(MockItem.description, "sleek").within(1, "shoes"))
)
...
stmt = (
    select(MockItem.description, MockItem.rating, MockItem.category)
    .where(search.proximity(MockItem.description, "sleek").within(1, "shoes", ordered=True))
)
...
stmt = (
    select(MockItem.description, MockItem.rating, MockItem.category)
    .where(search.proximity(MockItem.description, search.prox_regex("sl.*", 100).near(1, "shoes")))
)
