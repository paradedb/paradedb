...
```python Django
# Proximity operators (## / ##>) are not currently exposed by django-paradedb.
```
...
```python Django
# Proximity regex queries are not currently exposed by django-paradedb.
```
...
```python Django
# Proximity array queries are not currently exposed by django-paradedb.
```
...
```python Django
# Proximity array/regex queries are not currently exposed by django-paradedb.
```
