...
```ruby Rails
MockItem.where("description @@@ ('sleek' ##> 1 ##> 'shoes')")
        .select(:description, :rating, :category)
```
...
```ruby Rails
MockItem.where("description @@@ (pdb.prox_regex('sl.*') ## 1 ## 'shoes')")
        .select(:description, :rating, :category)
```
...
```ruby Rails
MockItem.where("description @@@ (pdb.prox_regex('sl.*', 100) ## 1 ## 'shoes')")
        .select(:description, :rating, :category)
```
...
```ruby Rails
MockItem.where("description @@@ (pdb.prox_array('sleek', 'white') ## 1 ## 'shoes')")
        .select(:description, :rating, :category)
```
...
```ruby Rails
MockItem.where("description @@@ (pdb.prox_array(pdb.prox_regex('sl.*'), 'white') ## 1 ## 'shoes')")
        .select(:description, :rating, :category)
```
