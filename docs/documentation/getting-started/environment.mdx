...
<Accordion title="Entity Framework Core">
To get started, create a .NET project with [EF Core](https://learn.microsoft.com/en-us/ef/core/), [Npgsql](https://www.npgsql.org/efcore/), and [ParadeDB.EntityFrameworkCore](https://www.nuget.org/packages/ParadeDB.EntityFrameworkCore) installed.
...
dotnet add package ParadeDB.EntityFrameworkCore --version 0.0.1
```
