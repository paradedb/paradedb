...
<Note>
  The [indexing](/api-reference/indexing) documentation provides an in-depth
...
<Accordion title="Expected Response">
  ...
  ----+----------------------------------+------------ 32 | <b>Bluetooth</b>
  -enabled speaker | 3.3322046 (1 row) ```
</Accordion>
...
<Accordion title="Expected Response">
  ...
  ---------------------------+----------------------------------+------------
  Bluetooth-enabled speaker | <b>Bluetooth</b>-enabled speaker | 3.3322046 (1
  row) ```
</Accordion>
