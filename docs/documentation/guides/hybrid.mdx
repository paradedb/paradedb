...
<Note>
  ...
  table](/documentation/introduction#get-started). It assumes that the entire
...
<Accordion title="Expected Response">
  ...
  0.01639344262295081967 | Artistic ceramic vase | [1,2,3] 39 |
  0.01639344262295081967 | Handcrafted wooden frame | [1,2,3] 29 |
  0.01639344262295081967 | Designer wall paintings | [1,2,3] (5 rows) ```
</Accordion>
