...
[normalized](/documentation/tokenizers/available-tokenizers/normalized), which default to
...
whereas literal and normalized fields are typically single-value and much more compact.
