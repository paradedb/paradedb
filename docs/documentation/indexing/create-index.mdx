...
<Note>
  ...
  [index tuning](/documentation/configuration/index-build) for details.
</Note>
...
Note that the index's column list contains fields of type text, JSON, numeric, timestamp, and boolean. See the [Field Configuration](/documentation/indexing/field-options) section for how to configure these fields.
