...
See the [Partitioning Guide](/documentation/indexing/partition-by) for column selection guidance, data type requirements, and co-partitioned join optimization.
