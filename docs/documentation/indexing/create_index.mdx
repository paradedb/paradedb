...
Instructions on how to configure and tokenize individual fields and data types can be found under the [Field Configuration](documentation/indexing/field_options) section.
