...
By default, Postgres' `maintenance_work_mem` allows `64MB` of indexing memory. For large indexes, a higher `maintenance_work_mem`
can speed up index build times significantly.
...
You can read more about indexing settings [here](/documentation/configuration/index).
