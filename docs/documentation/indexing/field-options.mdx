...
<ParamField body="fast" default={false}>
  See [fast fields](/documentation/indexing/fast-fields) for when this option
...
<ParamField body="normalizer">
  See [normalizers](/documentation/indexing/fast-fields#normalizers) for how to
...
<ParamField body="fast" default={false}>
  See [fast fields](/documentation/indexing/fast-fields) for when this option should be set to `true`.
</ParamField>
<ParamField body="tokenizer">
...
<ParamField body="normalizer">
  See [normalizers](/documentation/indexing/fast-fields#normalizers) for how to configure the normalizer.
</ParamField>
