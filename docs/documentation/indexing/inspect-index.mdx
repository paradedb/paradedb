...
In order for the index to maintain an optimal segment count, the index must have enough memory and threads for [creating](/documentation/configuration/index-build) and [writing](/documentation/configuration/write-throughput) to the index.
