...
In order for the index to maintain an optimal segment count, the index must have enough memory and threads for [creating](/documentation/configuration/index_build) and [writing](/documentation/configuration/write_throughput) to the index.
