...
```ruby Rails
ActiveRecord::Base.connection.execute("DROP INDEX search_idx;")
```
...
```ruby Rails
ActiveRecord::Base.connection.execute("REINDEX INDEX search_idx;")
```
...
```ruby Rails
ActiveRecord::Base.connection.execute("REINDEX INDEX CONCURRENTLY search_idx;")
```
