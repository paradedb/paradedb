...
If your join query is not currently supported by join pushdown, we invite you to request it by [opening a Github issue](https://github.com/paradedb/paradedb/issues).
