...
However, ParadeDB also includes a beta optimization called **join pushdown** that can significantly accelerate join queries when they involve ParadeDB search queries.
