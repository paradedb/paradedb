...
ParadeDB brings full-text and vector search, filtering, and aggregations to Postgres through a single index, so your data, queries, and infrastructure all live inside Postgres — no ETL pipelines, no separate cluster to manage.
...
| Boolean queries           |      ✅       |    ✅    | Via SQL `AND`/`OR`/`NOT`                                                                                                                                                  |
| Proximity search          |      ✅       |    ✅    | [`##` operator](/documentation/full-text/proximity)                                                                                                                       |
| More Like This            |      ✅       |    ✅    | [`pdb.more_like_this`](/documentation/query-builder/specialized/more-like-this)                                                                                           |
...
| Feature                             | Elasticsearch | ParadeDB | Notes                                                                                                                           |
| ----------------------------------- | :-----------: | :------: | ------------------------------------------------------------------------------------------------------------------------------- |
| Vector search (kNN)                 |      ✅       |    ✅    | [Native vector search](/documentation/vector/overview) (beta), using pgvector's `vector` type                                   |
| Filtered vector search              |      ✅       |    ✅    | ParadeDB indexes and filters vectors natively alongside text and metadata in the ParadeDB index, enabling efficient filtering   |
| Hybrid search                       |      ✅       |    ✅    | [Reciprocal rank fusion](/documentation/hybrid/rrf) over BM25 and vector rankings                                               |
| Distance functions                  |      ✅       |    ✅    | [L2, cosine, and inner product](/documentation/vector/querying)                                                                 |
| Recall / latency tuning             |      ✅       |    ✅    | [`paradedb.vector_cluster_max_probe`](/documentation/vector/tuning)                                                             |
| Incremental maintenance for updates |      ✅       |    ⚠️    | Updated vectors are immediately searchable, but index quality can degrade; [SPFresh is planned](/welcome/roadmap#vector-search) |
| Quantization (scalar, binary)       |      ✅       |    ⚠️    | Coming soon                                                                                                                     |
| Additional pgvector types           |      ✅       |    ⚠️    | Only `vector` is indexable today; support for `halfvec`, `sparsevec`, and `bit` is planned                                      |
| Built-in embedding inference        |      ✅       |    ❌    | If you need this feature, please [contact us](mailto:support@paradedb.com)                                                      |

### Relational and Specialized Queries
...
| Geospatial queries   |      ✅       |    ❌    | Use [PostGIS](https://postgis.net/)                                        |
| Percolate queries    |      ✅       |    ❌    | If you need this feature, please [contact us](mailto:support@paradedb.com) |
...
| Stemming                       |      ✅       |    ✅    | [20 languages](/documentation/token-filters/stemming)                                                                                                                                                                                                                                                                                                                                                                                          |
| Stopwords                      |      ✅       |    ✅    | [15 languages](/documentation/token-filters/stopwords)                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Fuzzy highlighting   |      ✅       |    ❌    | If you need this feature, please [contact us](mailto:support@paradedb.com)   |

## Index Management

| Feature           | Elasticsearch | ParadeDB | Notes                                                                               |
| ----------------- | :-----------: | :------: | ----------------------------------------------------------------------------------- |
| Create index      |      ✅       |    ✅    | [`CREATE INDEX ... USING paradedb`](/documentation/indexing/create-index)           |
