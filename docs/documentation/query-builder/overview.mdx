...
This uses the [regex](/documentation/query-builder/term/regex) query builder function to match all rows where `description` matches the regex expression `key.*rd`.
