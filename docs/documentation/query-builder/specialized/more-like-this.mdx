...
To use this query, pass the ID of the input document to `pdb.more_like_this`.
...
In addition to providing an ID value, a custom document can also be provided as JSON.
