...
canonical: https://docs.paradedb.com/documentation/tokenizers/available-tokenizers/exact
---
...
It is also required if the text field is used as a sort field in a [Top N](/documentation/full-text/topn) query,
or as part of an [aggregate](/documentation/aggregates).
