...
The literal normalized tokenizer is similar to the [literal](/documentation/tokenizers/available-tokenizers/exact) tokenizer in that it does not split the source text.
