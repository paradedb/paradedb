...
tokenizer for search, and the [literal](/documentation/tokenizers/available-tokenizers/exact) tokenizer for [Top N ordering](/documentation/sorting/topn).
...
<Note>
If a text field uses multiple tokenizers and one of them is [literal](/documentation/tokenizers/available-tokenizers/exact), we recommend aliasing
