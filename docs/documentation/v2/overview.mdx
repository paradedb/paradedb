...
No more complex JSON strings — index definitions are now clearer and more declarative.

### Text Search Operators

More intuitive syntax and more transparent behavior, making it easier to understand and control relevance scoring.

### ORM-Friendly Query Builders

Queries now support structured column references instead of relying on string literals, improving compatibility with query builders and reducing runtime errors.
