...
Under the hood, the [match](/documentation/v2/full-text/match) conjunction and disjunction operators get rewritten to this query builder function.
By default we recommend using [match](/documentation/v2/full-text/term) instead of this function.
