...
ParadeDB supports all regex constructs in the Rust [regex](https://docs.rs/regex/latest/regex/) crate, with the following exceptions:
...
<Note>
Regex queries operate at the token level. To execute regex over the original text,
