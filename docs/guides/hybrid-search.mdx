---
title: Hybrid Search
description: Combine full-text and vector search rankings with Reciprocal Rank Fusion
...
Fuse both candidate lists in a single SQL query.
...
Install `django-cte` in the environment from Start:
...
Retrieve the two candidate lists and fuse them in application code.
