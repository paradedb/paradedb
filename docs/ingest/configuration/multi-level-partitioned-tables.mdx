...
<Note>
  The `hive_partitioning` option must be set to '1' to enable multilevel partition support. 
  Ensure your S3 data is organized in the correct Hive-style structure for this feature to work properly.
</Note>
