...
This guide will walk you through how to query and copy a Parquet file stored in S3 to Postgres. The Parquet file
...
That's it! Please refer to the other sections for instructions on how to ingest from other [file and table formats](/ingest/datalakes/formats) and [object stores](/ingest/datalakes/object_stores).
