...
This approach is ideal for quickly bootstraping your ParadeDB cluster with some data. The best way to keep ParadeDB in sync with an existing Postgres database is by configuring [logical replication](/ingest/postgres/replication).
