...
This approach is ideal to quickly bootstrap your ParadeDB cluster with some data. The best way to keep ParadeDB in sync with an existing Postgres database is by configuring [logical replication](/ingest/postgres/replication).
