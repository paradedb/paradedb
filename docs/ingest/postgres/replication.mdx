...
If you are using a managed Postgres service, this can be configured via the dashboard UI. Here are the relevant links for commonly-used primary Postgres databases.

- [AWS RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.PostgreSQL.CommonDBATasks.Parameters.html)
- [Google CloudSQL](https://cloud.google.com/sql/docs/postgres/flags)
- [Google Cloud AlloyDB](https://cloud.google.com/alloydb/docs/instance-configure-database-flags)
- [Azure PostgreSQL](https://learn.microsoft.com/en-us/azure/postgresql/single-server/how-to-configure-server-parameters-using-cli)
