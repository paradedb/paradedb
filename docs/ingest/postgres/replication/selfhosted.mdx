...
<Info>
  This page is for configuring logical replication from a self-hosted Postgres
  instance into a ParadeDB deployment. To instead install the ParadeDB Postgres
  extensions directly in your self-hosted Postgres database, please refer to our
  [extension deployment documentation](/deploy/self-hosted/extensions).
</Info>
