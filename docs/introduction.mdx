...
similarity, and hybrid search. ParadeDB is not a fork of Postgres, but rather a collection of extensions
which can be installed on any Postgres 12+ database. ParadeDB itself ships with Postgres 15.
