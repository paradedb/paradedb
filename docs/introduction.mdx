...
- Developers who trust Postgres and want to stay within the Postgres ecosystem
...
- OLAP-style workloads that also require an OLTP data store for frequently-updated data or metadata storage
