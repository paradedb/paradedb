...
ParadeDB ships all of its functionality through its Postgres extensions. All updates to ParadeDB can be
...
If a new version of `pg_bm25` or `pg_sparse` is available, it will be listed in the [changelog]().
