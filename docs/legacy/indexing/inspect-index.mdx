...
In order for the index to maintain an optimal segment count, the index must have enough memory and threads for [creating](/documentation/performance-tuning/create-index) and [writing](/documentation/performance-tuning/writes) to the index.
