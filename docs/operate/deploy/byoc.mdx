...
canonical: https://www.paradedb.com/docs/operate/deploy/byoc
---
...
ParadeDB BYOC provisions a Kubernetes cluster in your cloud environment with [high availability](/operate/deploy/self-hosted/high-availability) preconfigured.
It also configures [logical replication](/operate/deploy/logical-replication/getting-started) with your primary Postgres, backups, connection pooling, monitoring, access control, and audit logging.
