...
canonical: https://www.paradedb.com/docs/operate/deploy/citus
---
...
- **ParadeDB indexes on distributed tables** — Create search indexes after distributing tables with `create_distributed_table()`
...
-- Create a ParadeDB index on the distributed table
...
2. **ParadeDB Base Scan** — Using the ParadeDB index within each shard
