...
canonical: https://www.paradedb.com/docs/operate/deploy/cloud-platforms/dokku
---
...
See the [Docker Hub page](https://hub.docker.com/r/paradedb/paradedb/tags) for available tags. Pin a tag (for example `paradedb/paradedb:{version}-pg18`) instead of `latest` for reproducible deploys.
