...
canonical: https://www.paradedb.com/docs/operate/deploy/logical-replication/configuration
---

<Note>
  This section assumes that you have successfully completed the [getting
  started](/operate/deploy/logical-replication/getting-started) guide and
  reviewed the [Logical Replication Operational
  Guide](/operate/deploy/logical-replication/operational-guide).
</Note>
...
- ParadeDB indexes are local to ParadeDB and must be created or rebuilt there
...
Safely](/operate/deploy/logical-replication/operational-guide#roll-out-ddl-safely).
...
Failures](/operate/deploy/logical-replication/operational-guide#troubleshoot-apply-failures).
...
Tables](/operate/deploy/logical-replication/operational-guide#add-new-tables).
