...
canonical: https://www.paradedb.com/docs/operate/deploy/logical-replication/getting-started
---
...
while ParadeDB receives the same row changes and maintains local ParadeDB indexes
...
<Warning>
  ...
  Operational Guide](/operate/deploy/logical-replication/operational-guide).
</Warning>
...
[Choose Publication and Subscription Boundaries](/operate/deploy/logical-replication/operational-guide#choose-publication-and-subscription-boundaries).
...
[Deploy ParadeDB](/operate/deploy/overview) on the subscriber, then load the extension in the subscriber database:
...
Boundaries](/operate/deploy/logical-replication/operational-guide#choose-publication-and-subscription-boundaries)
for the reasoning.
...
At this point, the base table is replicating correctly and you can create ParadeDB
indexes locally on ParadeDB. Continue to the [Logical Replication Operational
Guide](/operate/deploy/logical-replication/operational-guide) for ParadeDB
