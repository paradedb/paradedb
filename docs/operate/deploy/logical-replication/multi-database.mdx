...
canonical: https://www.paradedb.com/docs/operate/deploy/logical-replication/multi-database
---
...
1. Configure each source database as a publisher following the [Getting Started guide](/operate/deploy/logical-replication/getting-started)
...
- **No Source Database Changes**: Microservices continue operating independently; ParadeDB acts as a logical subscriber and search node
