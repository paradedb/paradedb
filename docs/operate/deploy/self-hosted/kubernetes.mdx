...
This guide also applies to clusters managed by platforms such as [Porter](https://docs.porter.run/addons/custom-helm-charts), which supports custom Helm charts. Configure access to your cluster before running the commands below. You remain responsible for database backups, upgrades, and monitoring.
