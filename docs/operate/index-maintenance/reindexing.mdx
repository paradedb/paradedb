...
canonical: https://www.paradedb.com/docs/operate/index-maintenance/reindexing
---
...
ON mock_items USING paradedb (id, description, category)
WITH (key_field = 'id');
```
...
From another session, you can use `pg_stat_progress_create_index` to [track the progress](/reference/indexing/create-index#track-create-index-progress) of the new index.
...
Invalid indexes should be dropped to free up storage.
