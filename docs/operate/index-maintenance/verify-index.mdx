...
canonical: https://www.paradedb.com/docs/operate/index-maintenance/verify-index
---
...
SELECT \* FROM pdb.verify*all_indexes(index_pattern := 'search*%');

-- Combine filters
SELECT \* FROM pdb.verify*all_indexes(
schema_pattern := 'app*%',
index_pattern := '%\_idx',
heapallindexed := true
);
