...
We're making rapid progress on our [roadmap](/project/roadmap#analytics) to fully push down aggregates to the BM25 index. The first aggregate we've pushed down
is `COUNT`.
