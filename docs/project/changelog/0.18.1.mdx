---
title: 0.18.1
description: "ParadeDB release notes for 0.18.1"
noindex: true
---

## New Features 🎉

- Introduced the ability to add [slop](/reference/full-text/phrase#adding-slop) to phrase queries in v2 of the API
