---
title: 0.20.1
description: "ParadeDB release notes for 0.20.1"
noindex: true
---
...
- Added an optional [toggle](/reference/aggregates/facets) to faceted queries to disable visibility checks, which can improve
