---
title: 0.21.3
description: "ParadeDB release notes for 0.21.3"
noindex: true
---
...
- [Positions](/reference/tokenizers/available-tokenizers/ngrams#phrase-and-proximity-queries-with-ngram) are supported for some ngram tokenizers
