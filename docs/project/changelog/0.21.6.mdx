---
title: 0.21.6
description: "ParadeDB release notes for 0.21.6"
noindex: true
---
...
- Fixed an issue where [filter pushdown](/reference/filtering/indexed) did not happen if non-text columns appeared after text columns in the index definition
