...
- Today, you can [deploy ParadeDB](/operate/deploy/overview) self-hosted, on cloud platforms, or with ParadeDB BYOC. ParadeDB Cloud is now available in private preview: fully managed ParadeDB with first-class search from Postgres and a developer experience to match. [Sign up](https://app.paradedb.com) to get started.
