...
<Note>
  ...
  assistance in deploying to production, please [contact
  sales](http://calendly.com/philippemnoel).
</Note>
...
neural_search_query = Search().neuralQuery("Who am I?", neural_search_fields)
