...
canonical: https://www.paradedb.com/docs/reference/aggregates/metrics/average
---
...
SQL's `AVG` syntax is supported in beta and is enabled by default. To disable it, run
