...
canonical: https://www.paradedb.com/docs/reference/full-text/all
---
...
To use it, pass the [key field](/reference/indexing/create-index#choosing-a-key-field) to the left-hand side of `@@@` and `pdb.all()` to the right-hand side.
...
like [Top K](/reference/full-text/top-k) or [aggregate](/reference/aggregates/overview) queries.
