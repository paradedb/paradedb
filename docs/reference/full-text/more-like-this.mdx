...
canonical: https://www.paradedb.com/docs/reference/full-text/more-like-this
---

The more like this (MLT) query finds documents that are "like" another document.
To use this query, pass the [key field](/reference/indexing/create-index#choosing-a-key-field) value of the input document
...
1. Stored values for the input document's fields are retrieved. If they are text fields, they are tokenized and filtered in the same way
   as the field was during [index creation](/reference/indexing/create-index).
