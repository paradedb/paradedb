...
canonical: https://www.paradedb.com/docs/reference/full-text/regex-phrase
---

Regex phrase matches a specific sequence of regex queries. Think of it like a conjunction of [regex](/reference/full-text/regex)
...
<ParamField body="phrases" required>
  ...
  [regex](/reference/full-text/regex) for allowed regex constructs.
</ParamField>
