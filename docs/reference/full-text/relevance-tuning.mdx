...
with connection.schema_editor() as schema_editor:
    schema_editor.add_index(
        ...
        ParadeDBIndex(
            fields={
                "id": {},
                "title": {"tokenizer": Tokenizer.simple(options={"k1": 0.9, "b": 0.3})},
                "body": {"tokenizer": Tokenizer.simple(options={"k1": 1.5, "b": 0.75})},
            },
            key_field="id",
            name="articles_idx",
        ),
...
idx = Index(
    "articles_idx",
    indexing.ParadeDBField(Article.id),
    indexing.ParadeDBField(
        Article.title,
...
ActiveRecord::Base.connection.add_paradedb_index(
  ...
  fields: {
    id: {},
    title: { tokenizer: ParadeDB::Tokenizer.simple(options: { k1: 0.9, b: 0.3 }) },
    body: { tokenizer: ParadeDB::Tokenizer.simple(options: { k1: 1.5, b: 0.75 }) }
  },
  key_field: :id,
  name: :articles_idx
)
...
modelBuilder.Entity<Article>()
    .HasParadeDbIndex("articles_idx", e => e.Id)
    .HasField(e => e.Title, Tokenizer.Simple(new() { ["k1"] = 0.9f, ["b"] = 0.3f }))
    .HasField(e => e.Body, Tokenizer.Simple(new() { ["k1"] = 1.5f, ["b"] = 0.75f }));
```
