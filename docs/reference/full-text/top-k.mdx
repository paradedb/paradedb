...
[keyword](/reference/tokenizers/available-tokenizers/keyword) tokenizer.
...
with either the literal or keyword tokenizer. See [indexing expressions](/reference/indexing/indexing-expressions) for more information.
