...
[keyword](/reference/tokenizers/available-tokenizers/keyword), which default to
...
whereas literal and keyword columns are typically single-value and much more compact.
