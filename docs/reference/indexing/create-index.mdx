...
Tokenizer types also accept per-field `k1` and `b` options to control BM25 scoring. See [BM25 Parameters](/reference/full-text/relevance-tuning#bm25-parameters) for defaults, syntax, and tuning guidance.
