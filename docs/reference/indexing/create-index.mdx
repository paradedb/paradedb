...
<Note>
  ...
  K](/reference/full-text/top-k), and [filtering](/reference/filtering/overview). `USING
  bm25` remains supported as a backwards-compatible alias for `USING paradedb`.
</Note>
...
See [Choosing a Key Field](/guides/choosing-a-key-field) for more detailed
guidance.
