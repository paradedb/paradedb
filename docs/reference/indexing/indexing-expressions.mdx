...
canonical: https://www.paradedb.com/docs/reference/indexing/indexing-expressions
---
            ...
            expressions=[
                IndexExpression(
                    ...
                    tokenizer=Tokenizer.simple(
                        options={"alias": "description_concat"}
                    ),
                ),
            ],
            key_field="id",
...
2. Cast it to a [tokenizer](/reference/tokenizers/overview), in this example `pdb.simple`.
