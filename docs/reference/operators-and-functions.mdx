...
| `::pdb.boost` | match, term, phrase, builders | [Relevance Tuning](/reference/full-text/relevance-tuning)                  |
| `::pdb.const` | `@@@` and query builders      | [Relevance Tuning](/reference/full-text/relevance-tuning#constant-scoring) |
