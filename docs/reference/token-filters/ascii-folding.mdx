...
canonical: https://www.paradedb.com/docs/reference/token-filters/ascii-folding
---
...
It is supported for all tokenizers besides the [literal](/reference/tokenizers/available-tokenizers/literal) tokenizer.
