...
canonical: https://www.paradedb.com/docs/reference/token-filters/lowercase
---
...
configured for all tokenizers besides the [literal](/reference/tokenizers/available-tokenizers/literal) tokenizer.
