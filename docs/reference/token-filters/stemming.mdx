...
canonical: https://www.paradedb.com/docs/reference/token-filters/stemming
---
...
Stemming can be configured for any tokenizer besides the [literal](/reference/tokenizers/available-tokenizers/literal) tokenizer. Stemmers
