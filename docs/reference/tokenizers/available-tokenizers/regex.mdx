...
canonical: https://www.paradedb.com/docs/reference/tokenizers/available-tokenizers/regex
---
...
Unlike [regex queries](/reference/full-text/regex), which match against the index's term dictionary, the tokenizer runs over the
