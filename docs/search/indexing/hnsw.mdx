...
HNSW indexes are designed for dense vectors, and support vectors with a maximum dimensionality of 2,000. For sparse vectors with larger dimensionality, ParadeDB also supports [sparse HNSW indexes](/search/indexing/sparse).
