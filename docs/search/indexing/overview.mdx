...
Note: Understanding the role of tokenizers is crucial for effective indexing. For a comprehensive guide on ParadeDB's tokenizers, see our [Tokenizer Documentation](../tokenizers.mdx).
