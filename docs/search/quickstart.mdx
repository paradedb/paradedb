...
ParadeDB supports a variety of additional full text search features like [fuzzy search](/search/full-text/fuzzy),
[autocomplete](/search/full-text/autocomplete),and [multi-language tokenizers](/search/indexing/bm25#tokenizers).
...
For advanced text processing and search customization, refer to our [Tokenizer Documentation](./tokenizers.mdx) to learn about the various tokenizers available in ParadeDB and how to configure them.
