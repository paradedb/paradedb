...
A sparse HNSW index can be created over any column with the `svector` type. Sparse vectors with up to `2,000`
...
<ParamField body="column_name" required>
  The name of the column being indexed. Must be of type `svector`.
</ParamField>
