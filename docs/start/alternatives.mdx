...
| **Update & delete support** | Built for fast-changing data                                        | Often more operationally expensive for frequent updates and deletes | Built for fast-changing data; [incremental vector index maintenance is in progress](/project/roadmap#vector-search)                                                  |
