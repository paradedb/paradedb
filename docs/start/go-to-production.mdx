...
[ParadeDB Enterprise](/operate/deploy/enterprise) adds commercial licensing,
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="key"
    href="/reference/indexing/create-index#choosing-a-key-field"
  >
...
query reference page and the [Read Throughput](/operate/performance-tuning/reads)
notes.
