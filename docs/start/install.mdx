...
sidebarTitle: Getting Started with Docker
description: How to run the ParadeDB Docker image
canonical: https://www.paradedb.com/docs/start/install
---
...
To see all the ways in which you can install ParadeDB, please refer to our [deployment documentation](/operate/deploy/overview).
If you'd rather not manage your own deployment, ParadeDB Cloud is coming soon. [Join the waitlist](https://www.paradedb.com/cloud) to get notified when it launches.

That's it! Next, let's [set up your environment](/start/connect-your-app) so we can run a few queries.
