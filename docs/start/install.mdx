...
If you'd rather not manage your own deployment, ParadeDB Cloud is now available in private preview. [Sign up](https://auth.paradedb.com/sign-up) to get started.
