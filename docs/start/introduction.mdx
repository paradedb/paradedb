...
ParadeDB Cloud is now available in private preview: a fully managed platform for running ParadeDB with better developer experience, higher performance, and more scalability than self-managing the extension. [Sign up](https://app.paradedb.com) to get started.
