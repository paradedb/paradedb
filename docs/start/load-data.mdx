...
sidebarTitle: Load Your Own Data
description: Dump data from an existing Postgres and load into ParadeDB
canonical: https://www.paradedb.com/docs/start/load-data
---
...
This approach is ideal for quickly testing ParadeDB. See the [deployment guide](/operate/deploy/overview) for how to deploy ParadeDB into production.
...
Congratulations! You are now ready to run real queries over your data. To learn more about query types, refer to our
[full text search documentation](/concepts/full-text/overview). When you are ready to go to production, see the
[deployment options](/operate/deploy/overview).
