...
<ParamField body="modelName" type="str" default="huggingface/sentence-transformers/all-MiniLM-L12-v2">
  A pretrained embedding model name. A list of all available pretrained models is available 
