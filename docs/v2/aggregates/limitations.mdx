...
If your query does not contain a ParadeDB operator, a way to "force" aggregate pushdown is to append the [all query](/v2/query-builder/compound/all) to the query's
`WHERE` clause.
