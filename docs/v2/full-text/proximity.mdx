---
title: Proximity
description: Proximity queries are used to match documents containing tokens that are within a certain token distance of one another.
canonical: https://docs.paradedb.com/v2/full-text/proximity
---
