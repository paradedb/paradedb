---
title: Term
description: Term queries look for exact token matches. A term query is like an exact string match, but at the token level.
canonical: https://docs.paradedb.com/v2/full-text/term
---
...
<Note>
  ...
  [lowercase](/v2/token-filters/lowercase) tokens by default. Make sure to
...
<Note>
  ...
  [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer.
</Note>
