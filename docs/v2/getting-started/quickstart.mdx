...
title: Quickstart
description: TODO
canonical: https://docs.paradedb.com/v2/getting-started/quickstart
---
...
<Note>
  ...
  field](/v2/indexing/create-index#choosing-a-key-field) for more details.
</Note>
...
Next, let's add BM25 scoring to the results, which allows us to sort matches by relevance. To do this, we'll use `pdb.score`.
