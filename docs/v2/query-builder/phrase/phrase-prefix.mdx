---
title: Phrase Prefix
description: The phrase prefix query finds documents containing a phrase followed by a term prefix.
canonical: https://docs.paradedb.com/v2/query-builder/phrase/phrase-prefix
---
