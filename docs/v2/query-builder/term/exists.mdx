...
canonical: https://docs.paradedb.com/v2/query-builder/term/exists
---
...
<Note>
Text fields must use the [literal](/v2/tokenizers/available_tokenizers/literal) tokenizer in order for `pdb.exists` to work.
</Note>
