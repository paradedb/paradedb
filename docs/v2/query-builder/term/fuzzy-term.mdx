---
title: Fuzzy Term
description: Fuzzy term finds results that approximately match the query token, allowing for a certain edit distance.
canonical: https://docs.paradedb.com/v2/query-builder/term/fuzzy-term
---
