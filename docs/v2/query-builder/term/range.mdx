...
canonical: https://docs.paradedb.com/v2/query-builder/term/range
---

<Note>For most use cases, we recommend using Postgres' native [range syntax](/v2/filtering) instead.</Note>
