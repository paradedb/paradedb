...
canonical: https://docs.paradedb.com/v2/query-builder/term/term
---

<Note>
  For most use cases, we recommend using the [term](/v2/full-text/term) query instead.
</Note>
...
Under the hood, the [term operator](/v2/full-text/term) gets rewritten to this query builder function.
By default we recommend using the [term operator](/v2/full-text/term) instead of this function.
