...
canonical: https://docs.paradedb.com/v2/sorting/topn
---
...
If a text field is present in the `ORDER BY` clause, it must be indexed with the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer.
...
See [indexing expressions](/v2/indexing/indexing-expressions) for more information.
