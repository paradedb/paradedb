---
title: ASCII Folding
description: The ASCII folding filter strips away diacritical marks like accents.
canonical: https://docs.paradedb.com/v2/token-filters/ascii-folding
---
...
It is supported for all tokenizers besides the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer.
