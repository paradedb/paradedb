---
title: Lowercase
description: The lowercase filter converts all characters to lowercase, allowing for case-insensitive queries.
canonical: https://docs.paradedb.com/v2/token-filters/lowercase
---
...
configured for all tokenizers besides the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer.
