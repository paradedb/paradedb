---
title: Stemmer
description: The stemmer is a language-specific token filter that reduces words to their root form.
canonical: https://docs.paradedb.com/v2/token-filters/stemming
---
...
Stemming can be configured for any tokenizer besides the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer.
