...
description: Prevent language-specific stopwords from being indexed.
canonical: https://docs.paradedb.com/v2/token-filters/stopwords
---
...
All tokenizers besides the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer can be configured to automatically remove stopwords
