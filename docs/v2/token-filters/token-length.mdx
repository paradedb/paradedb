---
title: Token Length
description: The token length filter automatically removes tokens that are above or below a certain byte length.
canonical: https://docs.paradedb.com/v2/token-filters/token-length
---
...
All tokenizers besides the [literal](/v2/tokenizers/available-tokenizers/exact) tokenizer accept these configurations.
