...
description: TODO
canonical: https://docs.paradedb.com/v2/token_filters/alpha_numeric
---
...
(i.e. `0` to `9`). It is supported for all tokenizers besides the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer.
