...
title: ASCII Folding
description: TODO
canonical: https://docs.paradedb.com/v2/token_filters/ascii_folding
---
...
It is supported for all tokenizers besides the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer.
