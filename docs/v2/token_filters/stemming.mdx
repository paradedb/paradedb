...
title: Stemmer
description: TODO
canonical: https://docs.paradedb.com/v2/token_filters/stemming
---
...
Stemming can be configured for any tokenizer besides the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer.
