...
description: TODO
canonical: https://docs.paradedb.com/v2/token_filters/stopwords
---
...
All tokenizers besides the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer can be configured to automatically remove stopwords
