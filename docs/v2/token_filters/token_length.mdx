...
title: Token Length
description: TODO
canonical: https://docs.paradedb.com/v2/token_filters/token_length
---
...
All tokenizers besides the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer accept these configurations.
