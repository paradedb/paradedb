...
compared to the [Chinese Lindera](/v2/tokenizers/available-tokenizers/lindera) and [Chinese compatible](/v2/tokenizers/available-tokenizers/chinese_compatible) tokenizers, but
