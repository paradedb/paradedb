---
title: Lindera
description: The Lindera tokenizer uses prebuilt dictionaries to tokenize Chinese, Japanese, and Korean text.
canonical: https://docs.paradedb.com/v2/tokenizers/available-tokenizers/lindera
---
