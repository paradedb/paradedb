---
title: Ngram
description: The ngram tokenizer splits text into "grams," where each "gram" is of a certain length. It is useful for partial matching.
canonical: https://docs.paradedb.com/v2/tokenizers/available-tokenizers/ngrams
---
