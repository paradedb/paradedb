...
canonical: https://docs.paradedb.com/v2/tokenizers/available-tokenizers/unicode
---
...
rules. All characters are [lowercased](/v2/token-filters/lowercase) by default.
...
(unless the text field is the [key field](/v2/indexing/create-index#choosing-a-key-field), in which case the text is not tokenized).
