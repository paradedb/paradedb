...
title: Jieba
description: TODO
canonical: https://docs.paradedb.com/v2/tokenizers/available_tokenizers/jieba
---
...
compared to the [Chinese Lindera](/v2/tokenizers/available_tokenizers/lindera) and [Chinese compatible](/v2/tokenizers/available_tokenizers/chinese_compatible) tokenizers, but
