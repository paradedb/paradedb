...
description: TODO
canonical: https://docs.paradedb.com/v2/tokenizers/multiple_per_field
---
...
tokenizer for search, and the [literal](/v2/tokenizers/available_tokenizers/exact) tokenizer for [Top N ordering](/v2/sorting/topn).
...
<Note>
If a text field uses multiple tokenizers and one of them is [literal](/v2/tokenizers/available_tokenizers/exact), we recommend aliasing
