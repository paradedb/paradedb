...
row-oriented layout. All text fields which use the [literal](/documentation/tokenizers/available-tokenizers/literal) tokenizer or are non-text are stored in the columnstore.
