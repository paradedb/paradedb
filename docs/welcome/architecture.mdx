...
row-oriented layout. All text fields which use the [literal](/http://localhost:3000/documentation/tokenizers/available-tokenizers/exact) tokenizer or are non-text are stored in the columnstore.
