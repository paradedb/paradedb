...
When a supported query uses a ParadeDB operator and the planner selects a ParadeDB index, ParadeDB executes it using a [custom scan](https://www.postgresql.org/docs/current/custom-scan.html).
