...
ParadeDB's custom scan allows filters, "top N" queries, and aggregates to be pushed down directly into the BM25 index. It also supports Postgres parallel workers, allowing query performance to scale
