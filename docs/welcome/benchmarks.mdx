...
Our benchmarks are run via the `cargo-paradedb` tool, which can be found [here](https://github.com/paradedb/paradedb/tree/dev/cargo-paradedb).
...
Data is generated and benchmarks are run with the [cargo-paradedb](https://github.com/paradedb/paradedb/tree/dev/cargo-paradedb#readme) tool.
