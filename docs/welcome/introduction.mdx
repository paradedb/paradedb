...
| **Scalability**             | Vertical scaling; horizontal scaling with read replicas or sharding | Horizontal scaling through sharding                                                                    | Vertical scaling; horizontal scaling with [read replicas on Kubernetes](/deploy/self-hosted/kubernetes) or [sharding with Citus](/deploy/citus) |
