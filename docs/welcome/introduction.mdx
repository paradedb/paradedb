...
| **Scalability**             | Vertical scaling; horizontal scaling with read replicas or sharding | Horizontal scaling through sharding                                                                    | Vertical scaling; horizontal scaling with read replicas or [Citus sharding](/deploy/citus)                                                      |
