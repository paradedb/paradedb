...
- **Vectors**: embeddings are indexed alongside your text and metadata, so filtered and [hybrid](/documentation/hybrid/overview) queries resolve against one index instead of
  intersecting two.
...
| **Update & delete support** | Built for fast-changing data                                        | Struggles with updates/deletes                                       | Built for fast-changing data; [incremental vector index maintenance is in progress](/welcome/limitations#vector-search)                         |
