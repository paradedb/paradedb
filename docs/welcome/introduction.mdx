...
| **Update & delete support** | Built for fast-changing data                                             | Struggles with updates/deletes                                                                         | Built for fast-changing data; [incremental vector index maintenance is still in progress](/welcome/limitations#vector-search)                   |
