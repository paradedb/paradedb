...
| **ACID guarantees**| Full ACID compliance | No transcations, atomic only per-document, eventual consistency, durability not guaranteed until flush | Full ACID compliance |
