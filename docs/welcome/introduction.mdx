...
| **ACID guarantees**         | Full ACID compliance, read-after-write guarantees                   | No multi-document ACID transactions; individual document operations are atomic | Full ACID compliance, read-after-write guarantees                                                                                               |
