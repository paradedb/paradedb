...
description: An overview of ParadeDB's limitations and tradeoffs.
...
our [performance guide](/documentation/configuration/read-throughput) for tuning Postgres' memory and parallelism settings.
