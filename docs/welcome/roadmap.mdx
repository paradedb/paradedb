...
- **More pgvector types**. Support for `halfvec` (fp16), in addition to the `vector` type that is indexed today.
- **Hybrid search**. Finalizing the architecture for fusing BM25 scores and vector distances into a single ranking.
