...
impl Table<ResearchProjectArraysTable> for ResearchProjectArraysTable {
    fn with() -> &'static str {
...
CREATE TABLE research_project_arrays_table (
    -- project_id UUID PRIMARY KEY,
    experiment_flags BOOLEAN[] NOT NULL,
    binary_data BYTEA[] NOT NULL,
    notes TEXT[] NOT NULL,
    keywords VARCHAR[] NOT NULL,
    short_descriptions BPCHAR[] NOT NULL,
    participant_ages INT2[] NOT NULL,
    participant_ids INT4[] NOT NULL,
    observation_counts INT8[] NOT NULL,
    -- related_project_o_ids OID[] NOT NULL,
    measurement_errors FLOAT4[] NOT NULL,
    precise_measurements FLOAT8[] NOT NULL,
    observation_timestamps TIMESTAMP[] NOT NULL,
    observation_dates DATE[] NOT NULL,
    budget_allocations NUMERIC[] NOT NULL,
    participant_uuids UUID[] NOT NULL
) USING deltalake;

INSERT INTO research_project_arrays_table (
    -- project_id,
    experiment_flags,
    binary_data,
    notes,
...
('b1fd9d22-2e5c-4af2-bf09-88f567abc123', ARRAY[false, true, false], ARRAY['\\xCAFEF00D'::bytea], 
