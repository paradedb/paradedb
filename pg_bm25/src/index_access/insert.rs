...
//         let ctid = {
//             let no = item_pointer_to_u64(last_ctid.unwrap());
//             let mut heap_tid = pg_sys::ItemPointerData::default();
//             u64_to_item_pointer(no + 1, &mut heap_tid);
//             &mut heap_tid as *mut pg_sys::ItemPointerData
//         };
...
//             let mut datum = song_json.into_datum().unwrap();
