...
CREATE TABLE dump_bm25 AS SELECT * FROM paradedb.bm25_test_table;
...
CREATE INDEX idxdumpbm25 ON dump_bm25 USING bm25 ((dump_bm25.*)) WITH (text_fields='{"description": {}, "category": {}}', numeric_fields='{"rating": {}}', boolean_fields='{"in_stock": {}}', json_fields='{"metadata": {}}');
