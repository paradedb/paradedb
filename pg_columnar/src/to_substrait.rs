...
pub fn postgres_to_datafusion_type(
    p_type: PgBuiltInOids
) -> Result<arrow_schema::DataType, Error> {
    // Map each PgBuiltInOids (the Postgres types) to a Datafusion type.
    // TODO: Are we covering all OIDs?
    // You can see the full list of OIDs here https://docs.rs/pgrx/latest/pgrx/pg_sys/type.PgBuiltInOids.html
    Ok(match p_type {
        PgBuiltInOids::BOOLOID => arrow_schema::DataType::Boolean,
        PgBuiltInOids::INT4OID => arrow_schema::DataType::Int32,
        PgBuiltInOids::INT8OID => arrow_schema::DataType::Int64,
        PgBuiltInOids::TEXTOID | PgBuiltInOids::VARCHAROID | PgBuiltInOids::BPCHAROID => arrow_schema::DataType::Utf8,
        // TODO: Add missing types
        PgBuiltInOids::INT2OID => arrow_schema::DataType::Int16,
        // TODO: user-specified precision
        PgBuiltInOids::NUMERICOID => arrow_schema::DataType::Decimal128,
        PgBuiltInOids::FLOAT4OID => arrow_schema::DataType::Float32,
        PgBuiltInOids::FLOAT8OID => arrow_schema::DataType::Float64,
        // TODO: Utf8 is variable length
        PgBuiltInOids::CHAROID => arrow_schema::DataType::Utf8,
        // TODO: Implement the rest of the types
...
// ) -> Result<proto::WriteRel, Error> {
    ...
    Ok(LogicalPlan::Dml(DmlStatement {
        ...
        op: match (*modify).operation {
            ...
            _ => datafusion::logical_expr::WriteOp::Unspecified,
        },
        input: result_plan
    }))
}
