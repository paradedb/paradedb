...
BEGIN
    ...
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_tables WHERE schemaname = schema_name AND tablename = table_name) THEN
        ...
        FOR data_to_insert IN
            SELECT * FROM (VALUES
                ('Ergonomic metal keyboard', 4, 'Electronics', true, '{"color": "Silver", "location": "United States"}'::JSONB, TIMESTAMP '2023-05-01 09:12:34', DATE '2023-05-03'),
                ('Plastic Keyboard', 4, 'Electronics', false, '{"color": "Black", "location": "Canada"}'::JSONB, TIMESTAMP '2023-04-15 13:27:09', DATE '2023-04-16'),
                ('Sleek running shoes', 5, 'Footwear', true, '{"color": "Blue", "location": "China"}'::JSONB, TIMESTAMP '2023-04-28 10:55:43', DATE '2023-04-29'),
                ('White jogging shoes', 3, 'Footwear', false, '{"color": "White", "location": "United States"}'::JSONB, TIMESTAMP '2023-04-20 16:38:02', DATE '2023-04-22'),
                ('Generic shoes', 4, 'Footwear', true, '{"color": "Brown", "location": "Canada"}'::JSONB, TIMESTAMP '2023-05-02 08:45:11', DATE '2023-05-03'),
                ('Compact digital camera', 5, 'Photography', false, '{"color": "Black", "location": "China"}'::JSONB, TIMESTAMP '2023-04-25 11:20:35', DATE '2023-04-26'),
                ('Hardcover book on history', 2, 'Books', true, '{"color": "Brown", "location": "United States"}'::JSONB, TIMESTAMP '2023-04-18 14:59:27', DATE '2023-04-19'),
                ('Organic green tea', 3, 'Groceries', true, '{"color": "Green", "location": "Canada"}'::JSONB, TIMESTAMP '2023-04-30 09:18:45', DATE '2023-05-01'),
                ('Modern wall clock', 4, 'Home Decor', false, '{"color": "Silver", "location": "China"}'::JSONB, TIMESTAMP '2023-04-24 12:37:52', DATE '2023-04-25'),
                ('Colorful kids toy', 1, 'Toys', true, '{"color": "Multicolor", "location": "United States"}'::JSONB, TIMESTAMP '2023-05-04 15:29:12', DATE '2023-05-06'),
                ('Soft cotton shirt', 5, 'Apparel', true, '{"color": "Blue", "location": "Canada"}'::JSONB, TIMESTAMP '2023-04-29 08:10:17', DATE '2023-04-30'),
                ('Innovative wireless earbuds', 5, 'Electronics', true, '{"color": "Black", "location": "China"}'::JSONB, TIMESTAMP '2023-04-22 10:05:39', DATE '2023-04-23'),
                ('Sturdy hiking boots', 4, 'Footwear', true, '{"color": "Brown", "location": "United States"}'::JSONB, TIMESTAMP '2023-05-05 13:45:22', DATE '2023-05-07'),
                ('Elegant glass table', 3, 'Furniture', true, '{"color": "Clear", "location": "Canada"}'::JSONB, TIMESTAMP '2023-04-26 17:22:58', DATE '2023-04-28'),
                ('Refreshing face wash', 2, 'Beauty', false, '{"color": "White", "location": "China"}'::JSONB, TIMESTAMP '2023-04-27 09:52:04', DATE '2023-04-29'),
                ('High-resolution DSLR', 4, 'Photography', true, '{"color": "Black", "location": "United States"}'::JSONB, TIMESTAMP '2023-04-21 14:30:19', DATE '2023-04-23'),
                ('Paperback romantic novel', 3, 'Books', true, '{"color": "Multicolor", "location": "Canada"}'::JSONB, TIMESTAMP '2023-05-03 10:08:57', DATE '2023-05-04'),
                ('Freshly ground coffee beans', 5, 'Groceries', true, '{"color": "Brown", "location": "China"}'::JSONB, TIMESTAMP '2023-04-23 08:40:15', DATE '2023-04-25'),
                ('Artistic ceramic vase', 4, 'Home Decor', false, '{"color": "Multicolor", "location": "United States"}'::JSONB, TIMESTAMP '2023-04-19 15:17:29', DATE '2023-04-21'),
                ('Interactive board game', 3, 'Toys', true, '{"color": "Multicolor", "location": "Canada"}'::JSONB, TIMESTAMP '2023-05-01 12:25:06', DATE '2023-05-02'),
        ...
        LOOP
            ...
            USING data_to_insert.description, data_to_insert.rating, data_to_insert.category, data_to_insert.in_stock, data_to_insert.metadata, data_to_insert.created_at, data_to_insert.last_updated_date;
        END LOOP;
