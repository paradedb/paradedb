...
CREATE  FUNCTION "score"(
    "_relation_reference" record /* pg_search::postgres::customscan::pdbscan::projections::OpaqueRecordArg */
) RETURNS real /* f32 */
...
/* </end connected objects> */
/* <begin connected objects> */
-- pg_search/src/postgres/customscan/pdbscan/projections/snippet.rs:39
