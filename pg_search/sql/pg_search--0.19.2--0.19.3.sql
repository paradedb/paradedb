...
CREATE OR REPLACE FUNCTION paradedb."agg_placeholder_agg_placeholder_state"(
...
CREATE OR REPLACE FUNCTION paradedb."agg_placeholder_agg_placeholder_finalize"(
	"this" internal /* pgrx::datum::internal::Internal */
...
CREATE AGGREGATE paradedb.agg (
	jsonb /* pgrx::datum::json::JsonB */
)
(
	SFUNC = paradedb."agg_placeholder_agg_placeholder_state", /* pg_search::api::aggregate::AggPlaceholder::state */
	STYPE = internal, /* pgrx::datum::internal::Internal */
	FINALFUNC = paradedb."agg_placeholder_agg_placeholder_finalize" /* pg_search::api::aggregate::AggPlaceholder::final */
);

/* <begin connected objects> */
-- pg_search/src/api/window_aggregate.rs:52
-- pg_search::api::window_aggregate::window_agg
CREATE OR REPLACE FUNCTION paradedb."window_agg"(
