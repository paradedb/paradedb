...
-- on-disk state.
CREATE OR REPLACE FUNCTION ivf_cluster_sizes(index regclass) RETURNS TABLE(segno text, field text, cluster_ord integer, size bigint) AS 'MODULE_PATHNAME', 'ivf_cluster_sizes_wrapper' LANGUAGE c STRICT;
