...
/// Segments written before the radius slot existed report zeros (exactly
/// how the gate sees them); segments written by an earlier
/// replica-INCLUSIVE fold report those larger, conservative values. Same
/// field resolution and locking discipline as [`vector_info`]; flat
/// segments contribute no rows.
#[allow(clippy::type_complexity)]
#[pg_extern]
