...
mod pdb {
    ...
    pub fn more_like_this_fields(
        ...
        max_term_frequency: default!(Option<i32>, "NULL"),
        min_query_terms: default!(Option<i32>, "NULL"),
        ...
        SearchQueryInput::MoreLikeThis {
            ...
            max_term_frequency: max_term_frequency.map(|n| n as usize),
            min_query_terms: min_query_terms.map(|n| n as usize),
