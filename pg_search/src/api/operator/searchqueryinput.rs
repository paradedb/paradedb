...
fn query_input_support_request_simplify(arg: pg_sys::Datum) -> Option<ReturnedNodePointer> {
    unsafe {
        pgrx::warning!("query_input_support_request_simplify: Starting function");
        ...
        let srs = match nodecast!(
            ...
            Some(node) => {
                pgrx::warning!("query_input_support_request_simplify: Successfully cast to SupportRequestSimplify");
                node
            }
            None => {
                pgrx::warning!("query_input_support_request_simplify: Failed to cast to SupportRequestSimplify");
                pgrx::warning!(
        ...
        if (*srs).fcall.is_null() {
            pgrx::warning!("query_input_support_request_simplify: fcall is null");
            return None;
        }
        ...
        let var = match nodecast!(Var, T_Var, input_args.get_ptr(0)?) {
            ...
            None => {
                pgrx::warning!("query_input_support_request_simplify: Left arg is not a Var");
                return None;
            }
        };
        ...
        let rhs = match input_args.get_ptr(1) {
            ...
            None => {
                pgrx::warning!("query_input_support_request_simplify: Right arg is missing");
                return None;
            }
        };
        ...
        if query.is_none() {
            pgrx::warning!("query_input_support_request_simplify: Failed to convert right arg to SearchQueryInput");
        } else {
            pgrx::warning!("query_input_support_request_simplify: Successfully converted right arg to SearchQueryInput");
        }
...
fn query_input_support_request_index_condition(arg: pg_sys::Datum) -> Option<ReturnedNodePointer> {
    unsafe {
        pgrx::warning!("query_input_support_request_index_condition: Starting function");
        ...
        let src = match nodecast!(
            ...
            Some(node) => {
                pgrx::warning!("query_input_support_request_index_condition: Successfully cast to SupportRequestIndexCondition");
                node
            }
            None => {
                pgrx::warning!("query_input_support_request_index_condition: Failed to cast to SupportRequestIndexCondition");
                pgrx::warning!(
        ...
        pgrx::warning!("query_input_support_request_index_condition: Examining node");

        if (*src).node.is_null() {
            pgrx::warning!("query_input_support_request_index_condition: node is null");
            return None;
        }
        ...
        if node_type == pg_sys::NodeTag::T_OpExpr {
            ...
            if is_our_operator {
                pgrx::warning!(
                    "query_input_support_request_index_condition: Found our BM25 operator"
                );
                    ...
                    if let (Some(larg), Some(rarg)) = (args.get_ptr(0), args.get_ptr(1)) {
                        ...
                        if let Some(var) = nodecast!(Var, T_Var, larg) {
                            ...
                            if let Some(const_) = nodecast!(Const, T_Const, rarg) {
                                ...
                                //     pgrx::warning!("query_input_support_request_index_condition: Created result list for text operator");
                                ...
                                //     );
                                //     if query.is_some() {
                                //         pgrx::warning!("query_input_support_request_index_condition: Successfully extracted search query");
                                ...
                                //         pgrx::warning!("query_input_support_request_index_condition: Created result list for query_input operator");
        ...
        pgrx::warning!(
            "query_input_support_request_index_condition: Could not handle index condition"
        );
        None
    }
}
