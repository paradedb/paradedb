...
/// Stride between sparse document matches, spanning across heap blocks.
...
/// Spans ~2,500 blocks to benchmark visibility map checks, fast field decoding,
/// and batch streaming over large segments.
