...
pub fn init() {
    ...
    GucRegistry::define_bool_guc(
        ...
        c"When enabled, DataFusion optimizer rules co-partition inner joins across tables on the boundaries their partitioned builds recorded. At least one participating table must have a partition_by index option defined. Default is false.",
