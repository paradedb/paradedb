...
impl SearchIndexReader {
    ...
    pub fn all_visible_segments(&self) -> tantivy::Result<HashSet<SegmentId>> {
        ...
        for segment in self.searcher.segment_readers() {
            let all_visible_segment = self.is_all_visible(segment)?;
            #[cfg(feature = "io_stats")]
            trace::count_segment(all_visible_segment);
            if all_visible_segment {
    ...
    pub fn is_all_visible(&self, segment: &SegmentReader) -> tantivy::Result<bool> {
        ...
        #[cfg(feature = "io_stats")]
        let _bounds_io = trace::columnar("Visibility Bounds");
        ...
        #[cfg(feature = "io_stats")]
        let _range_io = trace::external("Visibility Range");
