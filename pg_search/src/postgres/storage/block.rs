...
impl SegmentMetaEntry {
    ...
    pub fn increment_max_doc(&mut self, increment_by: u32) {
        self.header.max_doc += increment_by;
    }
    ...
    pub fn replace_deletes(&mut self, delete: DeleteEntry) -> Option<Self> {
        ...
        match &mut self.content {
            ...
            SegmentMetaEntryContent::Mutable(_) => {
                // TODO: See `freeable_blocks`: ideally this case would be impossible for mutable.
    ...
    pub fn byte_size(&self) -> u64 {
        let SegmentMetaEntryContent::Immutable(ref content) = self.content else {
            // Will probably want to make the byte_size optional to force consumers to consider
            // mutable segments independently.
            todo!("byte_size");
        };
