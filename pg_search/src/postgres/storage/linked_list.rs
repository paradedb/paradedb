...
mod tests {
    ...
    unsafe fn test_pathbuf_linked_list() {
        ...
        let cache = BM25BufferCache::open(relation_oid);
        let mut linked_list = LinkedItemList::<PathBuf>::create(relation_oid);
