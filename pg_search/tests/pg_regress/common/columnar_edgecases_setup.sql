...
-- The `edgecases` tests allow any number of columns to be used with columnar storage, in order to test
...
CREATE INDEX corner_case_search ON corner_case_test USING paradedb ((id::pdb.literal), (empty_string::pdb.simple('columnar=true')), (very_long_string::pdb.simple('columnar=true')), (special_chars::pdb.simple('columnar=true')), extreme_large, extreme_small, float_value, zero_value, negative_value, bool_field, (content::pdb.simple));
...
CREATE INDEX nullable_search ON nullable_test USING paradedb ((id::pdb.literal), (string_field::pdb.simple('columnar=true')), numeric_field, (content::pdb.simple));
...
CREATE INDEX mixed_string_edge_search ON mixed_numeric_string_test USING paradedb ((id::pdb.literal), numeric_field1, numeric_field2, (string_field1::pdb.simple('columnar=true')), (string_field2::pdb.simple('columnar=true')), (string_field3::pdb.simple('columnar=true')), (content::pdb.simple));
