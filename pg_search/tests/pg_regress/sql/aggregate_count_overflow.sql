...
CREATE INDEX idxusers ON users USING paradedb (id, (uuid::pdb.literal), (name::pdb.literal), (color::pdb.literal), age, quantity, price, small_numeric, int_numeric, high_scale, big_numeric, (upper(category)::pdb.literal), (literal_normalized::pdb.literal_normalized), (metadata::pdb.unicode_words('columnar=true'))) WITH (sort_by = 'age DESC NULLS LAST');
...
-- Note: Create the index before inserting rows to encourage multiple segments being created.
CREATE INDEX idxproducts ON products USING paradedb (id, (uuid::pdb.literal), (name::pdb.literal), (color::pdb.literal), age, quantity, price, small_numeric, int_numeric, high_scale, big_numeric, (upper(category)::pdb.literal), (literal_normalized::pdb.literal_normalized), (metadata::pdb.unicode_words('columnar=true'))) WITH (sort_by = 'age DESC NULLS LAST');
...
-- Note: Create the index before inserting rows to encourage multiple segments being created.
CREATE INDEX idxorders ON orders USING paradedb (id, (uuid::pdb.literal), (name::pdb.literal), (color::pdb.literal), age, quantity, price, small_numeric, int_numeric, high_scale, big_numeric, (upper(category)::pdb.literal), (literal_normalized::pdb.literal_normalized), (metadata::pdb.unicode_words('columnar=true'))) WITH (sort_by = 'age DESC NULLS LAST');
