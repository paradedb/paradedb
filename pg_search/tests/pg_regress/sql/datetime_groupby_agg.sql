...
USING paradedb (id, (organization_id::pdb.unicode_words('columnar=true')), live_mode, discarded_at, (internal_account_id::pdb.unicode_words('columnar=true')), unledgered_amount, as_of_date, description);
