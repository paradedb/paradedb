...
SELECT id
FROM events
WHERE occurred_at @@@ pdb.parse_with_field('[2024-01-02T00:00:00Z TO 2024-01-04T00:00:00Z}')
ORDER BY id;

SELECT id
FROM events
WHERE occurred_at_tz @@@ pdb.parse_with_field('[2024-01-02T00:00:00Z TO 2024-01-04T00:00:00Z}')
ORDER BY id;
