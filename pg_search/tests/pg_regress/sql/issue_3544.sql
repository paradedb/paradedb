...
INSERT INTO issue_3544_test (dates, info) VALUES ('1677-09-21', 'test');
CREATE INDEX ON issue_3544_test USING bm25 (id, dates, info) WITH (key_field = 'id');
DELETE FROM issue_3544_test;

INSERT INTO issue_3544_test (dates, info) VALUES ('2262-04-12', 'test');
CREATE INDEX ON issue_3544_test USING bm25 (id, dates, info) WITH (key_field = 'id');
DELETE FROM issue_3544_test;

INSERT INTO issue_3544_test (dates, info) VALUES ('2020-01-01', 'test');
INSERT INTO issue_3544_test (dates, info) VALUES ('1677-09-22', 'test');
INSERT INTO issue_3544_test (dates, info) VALUES ('2262-04-11', 'test');
CREATE INDEX ON issue_3544_test USING bm25 (id, dates, info) WITH (key_field = 'id');
