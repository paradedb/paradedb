...
CREATE INDEX idx_ints ON ints USING paradedb (id, ((i * 2)::pdb.alias('another_name')));
...
CREATE INDEX idx_ints ON ints USING paradedb (id, (add_two_numbers(i, j)::pdb.alias('another_name')));
