...
CREATE INDEX test_table_search_index ON public.test_table USING paradedb (id, col_ts_1, col_bool_1, col_uuid_1) WITH (layer_sizes='0', background_layer_sizes='100kb, 1mb, 100mb, 1gb');
