...
CREATE INDEX people_search_idx ON people USING paradedb (id, ((full_name)::pdb.literal_normalized), linkedin_followers, ((seniority_slug)::pdb.literal_normalized), company_id);
CREATE INDEX companies_search_idx ON companies USING paradedb (id);
