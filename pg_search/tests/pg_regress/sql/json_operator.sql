...
USING paradedb (id, description, category, rating, in_stock, created_at, (metadata::pdb.unicode_words('columnar=true')), weight_range);
...
CREATE INDEX search_idx ON mock_items USING paradedb (id, description, category, rating, in_stock, created_at, (metadata::pdb.literal), weight_range);
