...
CREATE INDEX ju_idx ON ju USING paradedb (id, (name::pdb.literal), (metadata::pdb.simple('columnar=true'))) WITH (key_field='id');
CREATE INDEX jp_idx ON jp USING paradedb (id, (name::pdb.literal)) WITH (key_field='id');
