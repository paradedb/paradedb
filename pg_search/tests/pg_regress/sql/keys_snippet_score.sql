...
CREATE INDEX bigint_test_idx ON bigint_test USING paradedb (id, (value::pdb.ngram(4, 4, 'prefix_only=false')));
...
CREATE INDEX uuid_test_idx ON uuid_test USING paradedb (id, (value::pdb.ngram(4, 4, 'prefix_only=false')));
...
CREATE INDEX timestamp_test_idx ON timestamp_test USING paradedb (id, (value::pdb.ngram(4, 4, 'prefix_only=false')));
