...
CREATE INDEX ON mlt USING paradedb (id, (text_field_a::pdb.simple), (text_field_b::pdb.simple), json_field, numeric_field);
...
CREATE INDEX ON mlt_vec USING paradedb (id, (description::pdb.simple), embedding);
...
INSERT INTO mlt_keyless VALUES
    ...
    (20, 2, 'beta beta', NULL);
CREATE INDEX mlt_keyless_idx ON mlt_keyless USING paradedb (tenant, id, (body::pdb.simple), ("Lookup Code"::pdb.simple));
...
CREATE INDEX mlt_keyless_idx ON mlt_keyless USING paradedb (
    tenant, id, (body::pdb.simple), ("Lookup Code"::pdb.literal('alias=lookup_code')));
...
DROP INDEX mlt_keyless_idx;
CREATE INDEX mlt_keyless_idx ON mlt_keyless USING paradedb (
    tenant, id, (body::pdb.simple), (lower("Lookup Code")::pdb.literal('alias=lookup_lower')));
...
CREATE INDEX mlt_text_key_idx ON mlt_text_key USING paradedb ((id::pdb.simple), (body::pdb.simple));
