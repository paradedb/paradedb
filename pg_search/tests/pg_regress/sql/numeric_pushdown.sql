...
-- ============================================================================
-- PART 8: Window Aggregate Tests for NUMERIC columns (TopK queries)
-- ============================================================================
-- Tests that window aggregates work correctly with Numeric64 fields
-- and are properly rejected for NumericBytes fields.
-- NOTE: Window aggregate pushdown only occurs for TopK queries (ORDER BY + LIMIT)

-- ----------------------------------------------------------------------------
-- TEST: Window aggregates on Numeric64 fields in TopK query (should work)
-- ----------------------------------------------------------------------------
...
-- Window aggregate SUM on Numeric64 field in TopK query - should be pushed down
...
-- Window aggregate AVG on Numeric64 field in TopK query
SELECT id, category, price,
...
-- Window aggregate MIN/MAX on Numeric64 field in TopK query
SELECT id, category, price,
...
-- ----------------------------------------------------------------------------
-- TEST: Window aggregates on NumericBytes fields in TopK query (should error)
-- ----------------------------------------------------------------------------
...
-- Window aggregate on NumericBytes field in TopK query should error
...
-- ----------------------------------------------------------------------------
-- TEST: Window aggregates on high-precision NUMERIC in TopK query (should error)
-- ----------------------------------------------------------------------------
...
-- Window aggregate on high-precision NUMERIC in TopK query should error
