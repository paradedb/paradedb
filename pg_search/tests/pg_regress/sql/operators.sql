...
-- These tests exercise BM25 search, not vector search, and they `SELECT *`. Drop the
-- embedding column so it stays out of their expected output; the VACUUM FULL below
-- reclaims its space.
