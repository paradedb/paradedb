...
SET seed TO 0.36793183982157274;
...
--
-- PostgreSQL query:
EXPLAIN SELECT users.id, users.name, users.age, products.age FROM users JOIN products ON users.uuid = products.uuid WHERE users.name  =  'bob' AND (products.name  =  'bob') OR (products.name  =  'bob') AND users.age > products.age ORDER BY users.id, products.id LIMIT 2;
SELECT users.id, users.name, users.age, products.age FROM users JOIN products ON users.uuid = products.uuid WHERE users.name  =  'bob' AND (products.name  =  'bob') OR (products.name  =  'bob') AND users.age > products.age ORDER BY users.id, products.id LIMIT 2;
--
