...
CREATE INDEX idxrequire_positions ON require_positions USING paradedb (id, (t::pdb.ngram(3, 3)));
...
CREATE INDEX idxrequire_positions ON require_positions USING paradedb (id, ((t->>'key1')::pdb.ngram(3, 3)));
