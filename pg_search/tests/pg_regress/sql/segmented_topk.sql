...
-- Verifies that SegmentedTopKExec is injected below the deferred lookup for
...
CREATE INDEX stk_documents_bm25_idx ON stk_documents USING paradedb ((id::pdb.literal), (category::pdb.unicode_words('columnar=true')));

CREATE INDEX stk_files_bm25_idx ON stk_files USING paradedb (id, (document_id::pdb.literal), (title::pdb.unicode_words('columnar=true')), (content::pdb.unicode_words('columnar=true')));
...
CREATE INDEX stk_files_bm25_idx ON stk_files USING paradedb (id, (document_id::pdb.literal), (title::pdb.unicode_words('columnar=true')), (content::pdb.unicode_words('columnar=true'))) WITH (mutable_segment_rows = 5000);
