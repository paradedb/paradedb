...
CREATE INDEX idxindex_text_array ON index_text_array USING paradedb (id, arr);
...
CREATE INDEX idxindex_text_array ON index_text_array USING paradedb (id, (arr::pdb.literal));
...
CREATE INDEX idxindex_varchar_array ON index_varchar_array USING paradedb (id, (arr::pdb.literal));
