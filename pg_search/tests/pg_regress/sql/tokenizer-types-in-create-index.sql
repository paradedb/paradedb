...
CREATE INDEX idxtok_in_ci ON tok_in_ci USING bm25
    (
     ...
     (t::pdb.lindera(chinese, 'keep_whitespace=true', 'alias=lindera_chinese_ws')),
     (t::pdb.lindera(japanese, 'keep_whitespace=true', 'alias=lindera_japanese_ws')),
     (t::pdb.lindera(korean, 'keep_whitespace=true', 'alias=lindera_korean_ws')),
