...
SELECT 'this is a test.'::pdb.lindera(chinese, 'keep_whitespace=true')::text[];
SELECT 'this is a test.'::pdb.lindera(japanese, 'keep_whitespace=true')::text[];
SELECT 'this is a test.'::pdb.lindera(korean, 'keep_whitespace=true')::text[];
