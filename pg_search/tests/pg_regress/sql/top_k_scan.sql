...
-- TODO: Many queries won't get TopK due to https://github.com/paradedb/paradedb/issues/2688
...
-- Test 12: 4-column ORDER BY uses TopK (issue #3148)
\echo 'Test 12: 4-column ORDER BY uses TopK'
EXPLAIN (FORMAT TEXT, COSTS OFF, TIMING OFF)
...
-- Test 13: 5-column ORDER BY uses TopK (issue #3148)
\echo 'Test 13: 5-column ORDER BY uses TopK'
EXPLAIN (FORMAT TEXT, COSTS OFF, TIMING OFF)
