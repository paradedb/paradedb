...
use crate::index_access::utils::{
    categorize_tupdesc, get_sparse_index, lookup_index_tupdesc, row_to_json,
};
...
unsafe fn aminsert_internal(
    ...
    let mut sparse_index = get_sparse_index(index_name);
    ...
    sparse_index.insert(&mut writer, *heap_tid, builder);
