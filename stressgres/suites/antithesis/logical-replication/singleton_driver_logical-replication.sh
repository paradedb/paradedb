...
/home/app/target/release/stressgres headless /home/app/stressgres/suites/logical-replication.toml --skip-setup --runtime 100000 --log-interval-ms 10000 --reconnect-grace 200000 --reconnect-grace-file /tmp/stressgres-reconnect-grace
