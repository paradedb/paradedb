...
echo ""
echo "Running Stressgres workload for wide-table.toml..."
...
/home/app/target/release/stressgres headless /home/app/stressgres/suites/wide-table.toml --skip-setup --runtime 100000 --log-interval-ms 10000 --reconnect-grace 3600000 --reconnect-grace-file /tmp/stressgres-reconnect-grace
