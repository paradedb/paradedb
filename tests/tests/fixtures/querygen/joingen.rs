...
pub fn arb_joins(
...
) -> impl Strategy<Value = JoinDescriptor> {
    ...
    (
        proptest::collection::vec(any::<JoinType>(), join_count),
        proptest::sample::subsequence(table_cols.clone(), join_count),
    )
